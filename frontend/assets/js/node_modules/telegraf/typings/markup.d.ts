import { ForceReply, InlineKeyboardButton, InlineKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove } from '../typings/core/types/typegram';
type Hideable<B> = B & {
    hide?: boolean;
};
...
export * as button from '../typings/button';
